...
#include "functs/csrc/jit/utils/common.h"
#include "functs/csrc/jit/utils/refine_type.h"
#include "functs/csrc/jit/utils/traits.h"
...
template <class... Args> inline c10::TypeError typeError(Args &&...args) {
...
inline c10::optional<std::vector<c10::optional<int64_t>>>
getIntList(Value *value) {
...
inline c10::optional<AttrType>
accumAttrFromElements(const TypePtr &listTy, GetFunc &&getFunc,
