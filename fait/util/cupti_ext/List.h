 ...
 * @param[in]  chipName                     Chip Name for which metrics are to
 * be listed
 * @param[in]  listSubMetrics               Whether submetrics(Peak, PerCycle,
 * PctOfPeak) are to be listed or not
 ...
 * @param[in]   pCounterAvailabilityImage   Pointer to counter availability
 * image queried on target device
 * @param[out]  pMetricsList                Supported Metrics list for given
 * chip
 */
