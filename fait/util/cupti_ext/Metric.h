 ...
 * @param[in]  chipName                          Chip name for which configImage
 * is to be generated
 * @param[in]  metricNames                       List of metrics for which
 * configImage is to be generated
 * @param[out] configImage                       Generated configImage
 * @param[in]  pCounterAvailabilityImage         Pointer to counter availability
 * image queried on target device, can be used to filter unavailable metrics
 */
 ...
 * @param[in]  chipName                  Chip name for which
 * counterDataImagePrefix is to be generated
 * @param[in]  metricNames               List of metrics for which
 * counterDataImagePrefix is to be generated
 ...
 * queried on target device, can be used to filter unavailable metrics
 */
